...
import { ArrowRight, Code, Hammer, Briefcase, DollarSign, BookOpen, Zap, Target, ArrowUpRight, ShieldCheck, Database } from "lucide-react";
    ...
    <>
        ...
        <div className="container px-4 md:px-6 mx-auto text-center relative z-10">
          <div className="flex flex-col items-center space-y-8">
            ...
            <p className="mx-auto max-w-[800px] text-gray-400 md:text-xl leading-relaxed">
              Combining 18+ years of enterprise sales expertise with autonomous, headless server AI deployment. We don't give you advice; we build the machine that executes it. Your 24/7 workforce is waiting.
            </p>
            ...
            {/* Social Proof Bar - Replacing basic stats with proprietary tech */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16 pt-12 border-t border-white/10 w-full max-w-5xl opacity-90 text-left">
              <div className="flex flex-col p-6 rounded-2xl bg-white/5 border border-white/10">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-lg font-bold text-white">Texas Foreclosure Deal-Sourcing Pipeline</span>
                </div>
                <span className="text-sm text-gray-400 leading-relaxed">
                  Autonomous ingestion of county records, cross-referenced with skip tracing APIs, feeding directly into a multi-channel outreach sequence.
                </span>
              </div>
              <div className="flex flex-col p-6 rounded-2xl bg-white/5 border border-white/10">
                <div className="flex items-center gap-3 mb-2">
                  <Database className="text-purple-400 h-6 w-6" />
                  <span className="text-lg font-bold text-white">Apollo API/LinkedIn Enriched Lead Engine</span>
                </div>
                <span className="text-sm text-gray-400 leading-relaxed">
                  Continuous programmatic enrichment scaling 1,000+ leads daily. We don't just scrape; we synthesize signals to trigger context-aware interactions.
                </span>
              </div>
            </div>
          </div>
      ...
      <section className="w-full py-12 bg-black overflow-hidden relative border-y border-white/5">
        ...
        <div className="container mx-auto px-4 mb-8 text-center">
          <p className="text-sm font-semibold text-gray-500 uppercase tracking-widest">A glimpse inside the deployment bay (520+ pre-trained agents)</p>
        </div>
      ...
      {/* 3. The Digital Workforce Grid (The 4 Pillars of Scale) */}
        ...
        <div className="container px-4 md:px-6 mx-auto">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <div className="group flex flex-col p-8 border border-gray-800 rounded-3xl bg-black hover:border-blue-500/50 hover:shadow-[0_0_30px_-5px_rgba(59,130,246,0.15)] transition-all duration-300">
              ...
              <h3 className="font-bold text-2xl mb-4">Architect Agent</h3>
            ...
            <div className="group flex flex-col p-8 border border-gray-800 rounded-3xl bg-black hover:border-green-500/50 hover:shadow-[0_0_30px_-5px_rgba(34,197,94,0.15)] transition-all duration-300">
              ...
              <h3 className="font-bold text-2xl mb-4">Builder Agent</h3>
              <p className="text-gray-400 leading-relaxed">
            ...
            <div className="group flex flex-col p-8 border border-gray-800 rounded-3xl bg-black hover:border-yellow-500/50 hover:shadow-[0_0_30px_-5px_rgba(234,179,8,0.15)] transition-all duration-300">
              ...
              <h3 className="font-bold text-2xl mb-4">Money Agent</h3>
              <p className="text-gray-400 leading-relaxed">
            ...
            <div className="group flex flex-col p-8 border border-gray-800 rounded-3xl bg-black hover:border-purple-500/50 hover:shadow-[0_0_30px_-5px_rgba(168,85,247,0.15)] transition-all duration-300">
              ...
              <h3 className="font-bold text-2xl mb-4">Operator Agent</h3>
              <p className="text-gray-400 leading-relaxed">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div>
              ...
              <p className="text-gray-400 md:text-xl max-w-2xl">
                We've trained hyper-focused agents for each of these core sectors.
              </p>
            </div>
            <Link href="/use-cases" className="text-blue-400 hover:text-blue-300 font-semibold flex items-center group">
              View All Pipeline Templates <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform"/>
            </Link>
          </div>
